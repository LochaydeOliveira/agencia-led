...
require_once BASE_PATH . '/email/PHPMailer/Exception.php';
require_once BASE_PATH . '/email/PHPMailer/PHPMailer.php';
require_once BASE_PATH . '/email/PHPMailer/SMTP.php';
