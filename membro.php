...
<header>
    <h1 class="text-center mb-4">Lista de Fornecedores Nacionais</h1>
</header>

<div class="container py-5">
    <p class="text-center mb-5">Confira abaixo a lista organizada de fornecedores nacionais por categoria, com links diretos.</p>
    
    <div class="row">
        <!-- Coluna lateral: busca + filtro -->
