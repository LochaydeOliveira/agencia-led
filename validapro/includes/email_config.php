...
if (!defined('SMTP_USER')) define('SMTP_USER', 'contato@agencialed.com');
if (!defined('SMTP_PASS')) define('SMTP_PASS', 'Lochayde@154719');
if (!defined('SMTP_SECURE')) define('SMTP_SECURE', 'tls');
if (!defined('SMTP_PORT')) define('SMTP_PORT', 587);
if (!defined('FROM_EMAIL')) define('FROM_EMAIL', 'contato@agencialed.com');
