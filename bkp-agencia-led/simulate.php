...
$payload = [
    ...
    'resource' => [
        ...
        'number' => $orderNumber,
        'value_total' => 19.90,
        'customer' => ['data' => ['id' => 229164211, 'name' => $name, 'email' => $email]],
        'items' => ['data' => [['product_id' => $productId, 'title' => 'Produto Simulado']]],
    ...
    <div class="mb-4">
        <?php if ($http_code === 200): ?>
            <div class="alert alert-success">
                ✅ Simulação <strong><?php echo htmlspecialchars($event); ?></strong> feita com sucesso!
            </div>
        <?php else: ?>
